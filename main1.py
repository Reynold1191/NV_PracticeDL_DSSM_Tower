...
class DSSM_Tower(pl.LightningModule): #mlp_sizes=[300, 300, 128]
    def __init__(self, n_users, n_items, n_ages, n_occs, n_genres, embed_dim=64, mlp_sizes=[256, 256, 256], dropout=0.3):
        super().__init__()
